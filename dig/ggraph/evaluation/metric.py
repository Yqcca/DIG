...
class PropOptEvaluator:
    ...
    def __init__(self, prop_name='qed'):
        assert prop_name in ['plogp', 'qed', 'median1', 'drd2', 'median2']
    ...
    def eval(self, input_dict):
        ...
        mols = input_dict['mols']
        if self.prop_name == 'qed':
            prop_fn = qed 
        elif self.prop_name == 'plogp':
            prop_fn = calculate_min_plogp
        elif self.prop_name == 'drd2':
            prop_fn = ADRD2
        elif self.prop_name == 'median1':
            prop_fn = AMEDIAN1
        elif self.prop_name == 'median2':
            prop_fn = AMEDIAN2
